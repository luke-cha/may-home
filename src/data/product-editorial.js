...
export const productEditorial = {
  ...
  'Silk Flower Wedding Arch': base({
    ...
    archPackage: {
      ...
      separate: t(['현장 운송', '철거 및 회수', '지방 출장', '야간·특수 설치', '추가 플라워'], ['On-site transport', 'Dismantling and collection', 'Travel outside the Seoul area', 'Night-time or special installation', 'Additional flowers']),
      note: t('공간의 규모와 웨딩 콘셉트, 플라워 구성에 따라 최종 견적이 달라질 수 있습니다.', 'The final quote may vary according to the scale of the space, wedding concept and floral composition.'),
    },
    ...
    productionTime: t('상담 후 안내드립니다.', 'Confirmed after consultation.'),
  }),
  '캔들라브라': base({
