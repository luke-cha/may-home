...
export const productEditorial = {
  ...
  '민들레 홑씨 내추럴 부케': bouquet({
    title: t('민들레 홑씨 내추럴 부케', 'Natural Dandelion Bouquet'), price: '180,000원',
    priceOptions: prices(['W25~30 × H35~40cm', '18만원', 'KRW 180,000']),
  ...
  'Silk Flower Wedding Arch': base({
    ...
    archPackage: {
      ...
      notes: t(['공간의 규모와 웨딩 콘셉트, 플라워 구성에 따라 최종 견적이 달라질 수 있으며,\n운송 및 철거 비용은 행사 장소와 일정에 따라 별도 안내됩니다.'], ['The final quote may vary according to the scale of the space, wedding concept and floral composition.\nTransport and dismantling fees are quoted separately according to the event location and schedule.']),
    },
