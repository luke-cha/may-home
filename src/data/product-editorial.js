...
export const productEditorial = {
  ...
  'Silk Flower Wedding Arch': base({
    ...
    archPackage: {
      ...
      separate: t(['현장 운송비', '철거 및 회수', '지방 출장비', '야간·특수 설치비', '추가 플라워'], ['On-site transport fee', 'Dismantling and collection', 'Travel fee outside the Seoul area', 'Night-time or special installation fee', 'Additional flowers']),
      notes: t(['공간의 규모와 웨딩 콘셉트, 플라워 구성에 따라 최종 견적이 달라질 수 있습니다.', '운송 및 철거 비용은 행사 장소에 따라 별도 안내됩니다.'], ['The final quote may vary according to the scale of the space, wedding concept and floral composition.', 'Transport and dismantling fees are quoted separately according to the event location.']),
    },
